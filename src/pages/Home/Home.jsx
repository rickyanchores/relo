  ...
  return (
    <div className='Home flex flex-col justify-center items-center min-h-screen' id="#">
        <div className="heroText h-80 w-screen flex justify-around items-end p-6">
          <div className="title font-thin text-6xl" data-aos="fade-right" data-aos-duration="6000">Premium Smart Watch Mockups</div>
        ...
        <img className='heroImage px-4' src="https://www.semplice.com/wp-content/uploads/2021/08/smartwatch-supply-store-bg-scaled.jpg" alt="imgHero" data-aos="fade-up" data-aos-duration="8000"/>
    </div>
  )
}
